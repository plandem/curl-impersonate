Wrapper around executing command to run impersonated curl. Suits for cases when you don't need super performance, and it's totally fine to run curl via commands.
